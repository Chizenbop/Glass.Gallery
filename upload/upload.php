 <?php include "http://people.oregonstate.edu/~hamc/cs275/header.htm"; ?> 
<?php
/**
...
<?php	
	if($error){
		...
		list($file,$error) = upload('image','uploads/','jpg,jpeg,gif,png');
		echo '<a href="http://people.oregonstate.edu/~hamc/cs275/upload/index.php">Upload Another Pic</a>';
	} 
?>
 <?php include "http://people.oregonstate.edu/~hamc/cs275/footer.htm"; ?> 